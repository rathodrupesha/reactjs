...
import BillTable from "../../components/Table/BillTable.js";
...
export default function CurrentUserList(props) {
  const createService = {
    name: "",
    description: "",
    loader: false,
      ...
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color="primary">
            ...
            >
              <h4 className={classes.cardTitleWhite}>Current User List</h4>
            </div>
          </CardHeader>
          <CardBody>
            <BillTable />

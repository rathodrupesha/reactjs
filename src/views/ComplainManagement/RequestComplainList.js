...
import RequestComplainTable from "../../components/Table/RequestComplainTable.js";
...
export default function RequestComplainTableList(props) {
  const createService = {
    name: "",
    description: "",
    loader: false,
      ...
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color="primary">
            ...
            >
              <h4 className={classes.cardTitleWhite}>Request Complain List</h4>
            </div>
          </CardHeader>
          <CardBody>
            <RequestComplainTable />
          </CardBody>
        </Card>
      </GridItem>
    </GridContainer>
